...
// echo "<pre>";
// print_r($_POST); // Lihat data inputan form
// print_r($_FILES); // Lihat data inputan form
// echo "</pre>";

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Variabel dari form
    $directorName = mysqli_real_escape_string($koneksi, $_POST['nama_direktur_utama']);
    $directorPhone = mysqli_real_escape_string($koneksi, $_POST['telepon_direktur_utama']);
    $picName = mysqli_real_escape_string($koneksi, $_POST['nama_pic']);
    $picPhone = mysqli_real_escape_string($koneksi, $_POST['telepon_pic']);

    // Variabel untuk manajemen keuangan
    $accountingFirm = mysqli_real_escape_string($koneksi, $_POST['nama_kantor']);
    $publicAccountantOpinion = mysqli_real_escape_string($koneksi, $_POST['opini_akuntan']);

    // Variabel untuk teknologi
    $trlLevel = intval($_POST['trl']);
    $mrlLevel = intval($_POST['mrl']);

    // Variabel untuk fasilitas produksi
    $ownershipType = mysqli_real_escape_string($koneksi, $_POST['kepemilikan_sarana']);
        ...
        foreach ($files['name'] as $key => $fileName) {
            ...
            if ($fileError === UPLOAD_ERR_OK) {
                ...
                $errorMessages = [
                    ...
                    UPLOAD_ERR_NO_FILE    => "Tidak ada file yang diunggah untuk {$fileName}.",
