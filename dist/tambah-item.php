                        ...
                        <div class="row">
                            <div class="col-4"> 
                                <div class="mb-3 mt-2">
                                    ...
                                    <input name="nama_obat" type="text" class="form-control" id="nama_obat" 
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="pedoman_pemakaian" class="form-control" id="pedoman_pemakaian" rows="3"
                                    ><?=@$obat['pedoman_pemakaian'] ?></textarea>
                                </div>
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="efek_samping" class="form-control" id="efek_samping" rows="3"
                                    ><?=@$obat['efek_samping'] ?></textarea>
                                </div>
                            </div>
                            <div class="col-4">
